...
import gridscheduler.model.Node;
import gridscheduler.model.NodeStatus;

import java.awt.*;
import java.util.List;
import java.util.Queue;

import static gridscheduler.model.ResourceManager.MAX_QUEUE_SIZE;
...
public class ClusterStatusPanel extends StatusPanel {
    ...
    protected void paintComponent(Graphics g) {
	    ...
	    //TODO redo this in order for the jobQueue to be visible underneath the node list (accomodate an arbitrary size of job queue)
